...
const AddCustomer: FC<AddCustomerProps> = ({}) => {
    ...
    const [formData, setFormData] = useState({firstName: "", lastName: "", email: "", serviceDue: false, visits: [], phone: ""})
    ...
    const handleSubmit = (e : React.FormEvent<HTMLButtonElement>) => {
        ...
        setFormData({firstName: "", lastName: "", email: "", serviceDue: false, visits: [], phone: ""});

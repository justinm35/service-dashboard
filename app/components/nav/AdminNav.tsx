...
const AdminNav: FC<AdminNavProps> = ({}) => {
  ...
  return (
    ...
    <li>
      <Link href="/dashboard/customer" className={"relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6" +
        (activeSegment === 'customer' ? " text-indigo-500 font-semibold " : " text-gray-600 ")}>
        <span className="inline-flex justify-center items-center ml-4">

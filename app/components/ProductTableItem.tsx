  ...
  return (<>
          {prevPDF ? 
            <div className='w-1/2 h-full  bg-white absolute rounded-md shadow-lg z-20  m-auto left-0 right-0 top-20'>
              <button className=' text-gray-900' onClick={()=>setPrevPDF(undefined)}>
                <XMarkIcon className='w-5 h-5 mt-2 ml-2'/>
              </button>
        ...
        <tr className="hover:bg-gray-50">
          ...
          <td className="px-6 py-4 font-normal text-gray-900">
            <div className="text-sm">
              <div className="font-medium text-zinc-500">{product.modelNum}</div>
            </div>
          </td>
          <td className="px-6 py-4 font-normal text-gray-900">
            <div className="text-sm">
              <div className="font-medium text-zinc-500">{product.category}</div>
            </div>
          </td>
          <td className="px-6 py-4"><a onClick={()=>setPrevPDF(product.warrantyLink)} className='underline opacity-70 hover:opacity-90 cursor-pointer'>View</a></td>
          <td className="px-6 py-4"><a onClick={()=>setPrevPDF(product.manualLink)} className='underline opacity-70 hover:opacity-90 cursor-pointer'>View</a></td>
